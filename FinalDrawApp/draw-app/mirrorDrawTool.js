//a tool to draw simultaniously on 2 sides of canvas symmetrically
function MirrorDrawTool() {
	...
	this.populateOptions = function () {
		select(".options").html(
			"<p class = 'options' style = 'padding-left: 11rem;'>Stroke</p> <button id='directionButton' class='helperButton'>Make Horizontal</button> <input type='range' min= '1' max='50' value='2' class='slider' id='myRange'>");
		//click handler
